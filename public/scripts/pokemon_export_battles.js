...
function loadHighscores() {
  ...
  var query = db.collection('battles');
...
function displayHighscore(id, ranking, exportData) {
  ...
  var EXPORT_DATA = exportData.attack1name + ', ' + exportData.attack1strength +
                    ', '  + exportData.attack2name + ', ' + exportData.attack2strength +
                    ', '  + exportData.attack3name + ', ' + exportData.attack3strength +
                    ', '  + exportData.defend1name + ', ' + exportData.defend1strength +
                    ', '  + exportData.defend2name + ', ' + exportData.defend2strength +
                    ', '  + exportData.defend3name + ', ' + exportData.defend3strength +
                    ', '  + exportData.battle1score +
                    ', '  + exportData.battle2score +
                    ', '  + exportData.battle3score +
                    ', '  + exportData.totalBattleScore +
